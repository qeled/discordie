...
class RequestQueueManager {
  constructor(discordie) {
    ...
    // per-guild reactions 1/.25s
    const _reactions =
      this._createBucketFactory(1, 250, "reactions", _bot_global);
    this.messageReactionQueues = new RequestQueueGroup(_reactions);
  ...
  putReaction(request, channelId, sendCallback) {
    const group = this.messageReactionQueues;
