...
const Intents = {
  ...
  GUILD_PRESENCES: 1 << 8, // Privileged intent
  GUILD_MESSAGES: 1 << 9,
...
const Constants = {
  ...
  Events: {
    ...
    /**
     * Emitted when all instances of a given reaction are cleared.
     ...
     * @property {Object} data - Raw object received from server
     * @property {Function} getCachedData
     * Function returning an array of removed reaction or null. returns what???
     */
    MESSAGE_REACTION_REMOVE_EMOJI: 0,

    /**
     * Emitted when guild invite is created.
     * @event INVITE_CREATE
     * @property {GatewaySocket} socket
     * @property {IGuildMember|IUser} User that created the invite
     * @property {IGuild|null} guild invite was created in
     * @property {IChannel|null} channel the invite is for
     * @property {Object} invite data received from server
     */
    INVITE_CREATE: 0,

    /**
     * Emitted when guild invite is deleted.
     * @event INVITE_DELETE
     * @property {GatewaySocket} socket
     * @property {IGuild|null} guild the invite was deleted from
     * @property {IChannel|null} channel the invite is for
     * @property {String|null} code invite code that was deleted
     */
    INVITE_DELETE: 0,
  },
  ChannelTypes: {
  ...
  Endpoints: {
    ...
    GUILD_EMBED: guildId => `/guilds/${guildId}/widget`,
  ...
  API_VERSION: 8,
  get API_ENDPOINT() {
    return "https://discord.com/api/v" + this.API_VERSION;
  },
