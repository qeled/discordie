...
class IAuthenticatedUser extends IBase {
   ...
   * @param {Object|String|null} [game]
   * Object `{type: Number, name: String}` or string
   * @example
   * // sets status as "Playing with code"
   * var game = {type: 0, name: "with code"};
   * // "Streaming"
  ...
  setStatus(status, game) {
    ...
    if (typeof game === "string") game = {type: 0, name: game};
   ...
   * Object `{type: Number, name: String}` or string
   * @example
   * // sets game as "Playing with code"
   * var game = {type: 0, name: "with code"};
   * // "Streaming"
   * var streamingGame = {type: 1, name: "something", url: ""};
   * // note: streaming status requires a valid twitch url:
