...
function createGuildMember(member, old) {
  ...
  return new GuildMember({
    ...
    roles: member.roles || [],
    mute: member.mute || old.mute || false,
    deaf: member.deaf || old.deaf || false,
    self_mute: member.self_mute || old.self_mute || false,
    self_deaf: member.self_deaf || old.self_deaf || false,
