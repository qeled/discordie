...
function createGuildMember(member, old) {
  ...
  return new GuildMember({
    ...
    roles: member.roles || [],
    mute: (member.mute != null ? member.mute : old.mute) || false,
    deaf: (member.deaf != null ? member.deaf : old.deaf) || false,
    self_mute: (member.self_mute != null ? member.self_mute : old.self_mute) || false,
    self_deaf: (member.self_deaf != null ? member.self_deaf : old.self_deaf) || false,
    joined_at: member.joined_at || old.joined_at,
    client_status: member.client_status || old.client_status
  });
}
...
function handleGuildMemberCreateOrUpdate(member, e) {
  ...
  const next = createGuildMember(member, prev);
