...
function convertOverwrites(overwrites) {
  if (!overwrites || !overwrites.length) return overwrites;
...
function createChannel(channel) {
  return new Channel({
    ...
    permission_overwrites: convertOverwrites(channel.permission_overwrites)
  });
}
