...
const GuildExplicitContentFilterTypes = Constants.GuildExplicitContentFilterTypes;
...
function createGuild(guild, old) {
  return new Guild({
    ...
    explicit_content_filter:
      guild.explicit_content_filter || GuildExplicitContentFilterTypes.DISABLED,
...
function handleInviteCreate(data, e) {
  // noop for now
}

function handleInviteDelete(data, e) {
  // noop for now
}
